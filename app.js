...
window.openDossier = function(id) {
    ...
    modalBody.innerHTML = `
        ...
        <div style="width:100%; height:280px; border:4px solid var(--ink-black); box-shadow:6px 6px 0px var(--ink-black); margin-bottom:1.5rem; overflow:hidden;">
            <img src="${hero.image}" alt="${hero.alias}" style="width:100%; height:100%; object-fit:cover;" onerror="this.onerror=null; this.src='https://via.placeholder.com/650x300/ffde00/121212?text=HERO+CLASSIFIED';">
        </div>
        ...
        <div style="display:grid; gap:0.85rem; font-size:1.05rem;">
            ...
            <div class="narrative-box" style="background:#e1f5fe;"><strong>🦸‍♂️ SQUAD / AFFILIATION:</strong> ${hero.affiliation}</div>
            ...
            <div class="narrative-box" style="background:#fff;"><strong>🛡️ GEAR & WEAPONRY:</strong> ${hero.signature_gear}</div>
